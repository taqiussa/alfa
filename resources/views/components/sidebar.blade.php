<aside
    class="absolute lg:relative z-10 w-60 transform inset-0 h-screen duration-700 bg-white border-r-2 border-emerald-700 p-3"
    :class="{ 'translate-x-0 ease-in': open === true, '-translate-x-[120%] lg:translate-x-0 ease-out': open === false }">
